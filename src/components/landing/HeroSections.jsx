        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col items-center justify-center gap-3">
              <Link to="/signin" className="btn btn-accent text-base-100 text-[15px] px-7 py-5 font-bold shadow-md/60 hover:shadow-none transition-all text-shadow-none rounded-full">Upload Resume</Link>
              <a href="#how-to-use-it" className="btn btn-soft border border-accent text-accent text-[15px] px-7 py-5 font-bold shadow-md/60 hover:shadow-none transition-all text-shadow-none rounded-full">See how to use it</a>
            </div>
          </div>
        </div>
      </div>
